# AWS Infrastructure for PhysioCare Platform
terraform {
...
resource "aws_elasticache_replication_group" "main" {
  ...
  description                = "Redis cluster for PhysioCare"
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        {
          name  = "DATABASE_URL"
          value = "postgresql://postgres:${var.db_password}@${aws_db_instance.main.endpoint}/physiotherapy"
        },
        {
          name  = "REDIS_URL"
